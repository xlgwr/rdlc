namespace rdlc.Matrix
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.NorthwindDataSet = new rdlc.Matrix.NorthwindDataSet();
            this.vReportProductsBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.vReportProductsTableAdapter = new rdlc.Matrix.NorthwindDataSetTableAdapters.vReportProductsTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "rdlc.Matrix.Report1.rdlc";
